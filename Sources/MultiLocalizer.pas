...
type
  ...
  public
    ...
    function AddForm(const lForm: TForm;
      const lExcludeClear: Boolean = True): Integer;
...
function TMultiLocalizer.AddForm(const lForm: TForm;
  const lExcludeClear: Boolean): Integer;
begin
  Result := fFormsCount;
