...
type
  TManagerOfRealHibernate = class(TMainFrame)
  private
...
constructor TManagerOfRealHibernate.Create;
begin

end;

function TManagerOfRealHibernate.DoAction: Cardinal;
var
  hToken: THandle;
