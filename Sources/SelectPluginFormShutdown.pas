...
begin
  ...
  PostMessage(gvMainFormHandle, WMU_PLUGIN_SELECTED, PluginList.Selected, 0);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ListItem.SubItems.Add(Format('%u.%u.%u.%u',
          [Magor, Minor, Release, Build]));
      end;
    end;
  end;
  ...
  begin
    ...
    BPluginSettings.Visible := PluginList.SelectedItem.PluginInfo.HasSettings;
  end;
...
procedure TSelectPlugin.LVPluginListSelectItem(Sender: TObject; Item: TListItem;
  Selected: Boolean);
begin
